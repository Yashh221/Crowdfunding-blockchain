...
const Navbar = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 h-[52px] bg-[#1c1c24]">
        <input
          type="text"
      ...
      <div className="sm:hidden flex justify-between items-center relative">
        ...
        />
        <div
          className={`absolute pb-8 top-[60px] right-0 left-0 rounded-[10px] bg-[#1c1c24] z-10 shadow-secondary py-4 ${
          ...
          <ul className="mb-4">
            {navlinks.map((link) => (
              <li
                key={link.name}
                className={`flex p-4 ${
                  isActive === link.name && "bg-[#3a3a43000000]"
                }`}
                onClick={() => {
